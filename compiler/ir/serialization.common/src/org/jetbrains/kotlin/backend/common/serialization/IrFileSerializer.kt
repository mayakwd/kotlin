...
open class IrFileSerializer(
    ...
    private fun serializeIrClass(clazz: IrClass): ProtoClass {
        ...
        if (representation != null) {
            proto.inlineClassUnderlyingPropertyName = serializeName(representation.underlyingPropertyName)
            // TODO: consider not writing type if the property is public, similarly to metadata
            proto.inlineClassUnderlyingPropertyType = serializeIrType(representation.underlyingType)
        }
